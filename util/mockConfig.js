...
module.exports = app => {
	...
	const { dir } = mock
	const { join } = path
	const rule_get = path.join(dir, 'get'),
		rule_post = path.join(dir, 'post'),
		rule_delete = path.join(dir, 'delete'),
		rule_put = path.join(dir, 'put')
	...
	let files_get = findSync(rule_get),
		files_post = findSync(rule_post),
		files_delete = findSync(rule_delete),
		files_put = findSync(rule_put),
		mockList_get = [],
		mockList_post = [],
		mockList_delete = [],
		mockList_put = []
